...
{
    public partial class FallGuys : Form
    {
        public FallGuys()
        {
            InitializeComponent();
        ...
        private void FortniteSpecs_Click(object sender, EventArgs e)
        {
            ...
            // Call the GetGameSpecs method to fetch system specs for Fall Guys
            SystemSpec gameSpecs = dataAccess.GetGameSpecs(fallguysGameID);
            ...
            if (gameSpecs != null)
            {
                ...
                MessageBox.Show(specsMessage, "Fall Guys System Specifications", MessageBoxButtons.OK);
            }
            else
            {
                MessageBox.Show("System specifications not found for Fall Guys.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
