...
{
    public partial class MinecraftDungeons : Form
    {
        public MinecraftDungeons()
        {
            InitializeComponent();
        }
        ...
        private void minecraftdungeonsSpecs_Click(object sender, EventArgs e)
        {
            int minecraftdungeonsGameID = 19;
            ...
            // Call the GetGameSpecs method to fetch system specs for Minecraft Dungeons
            SystemSpec gameSpecs = dataAccess.GetGameSpecs(minecraftdungeonsGameID);
            ...
            if (gameSpecs != null)
            {
                ...
                MessageBox.Show(specsMessage, "Minecraft Dungeons System Specifications", MessageBoxButtons.OK);
            }
            else
            {
                MessageBox.Show("System specifications not found for Minecraft Dungeons.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
