...
{
    public partial class CitiesSkylines : Form
    {
        public CitiesSkylines()
        {
            InitializeComponent();
        }
        ...
        private void CitiesSkylinesIISpecs_Click(object sender, EventArgs e)
        {
            int citiesskylinesGameID = 7;
            ...
            // Call the GetGameSpecs method to fetch system specs for cites: skylines ii
            SystemSpec gameSpecs = dataAccess.GetGameSpecs(citiesskylinesGameID);
            ...
            if (gameSpecs != null)
            {
                ...
                MessageBox.Show(specsMessage, "Cities Skylines II System Specifications", MessageBoxButtons.OK);
            }
            else
            {
                MessageBox.Show("System specifications not found for Cities Skylines II.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
