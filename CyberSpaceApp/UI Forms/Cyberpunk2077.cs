...
namespace CyberSpaceApp.UI_Forms
{
    public partial class Cyberpunk2077 : Form
    {
        ...
        private void cyberpunk2077Specs_Click(object sender, EventArgs e)
        {
            int cyberpunk2077GameID = 15;
            ...
            // Call the GetGameSpecs method to fetch system specs for Cyberpunk 2077
            SystemSpec gameSpecs = dataAccess.GetGameSpecs(cyberpunk2077GameID);
            ...
            if (gameSpecs != null)
            {
                ...
                MessageBox.Show(specsMessage, "Cyberpunk 2077 System Specifications", MessageBoxButtons.OK);
            }
            else
            {
                MessageBox.Show("System specifications not found for Cyberpunk 2077.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
