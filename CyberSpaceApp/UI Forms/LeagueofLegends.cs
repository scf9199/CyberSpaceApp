...
{
    public partial class LeagueofLegends : Form
    {
        ...
        private void LOLSpecs_Click(object sender, EventArgs e)
        {
            int lolGameID = 17;
            ...
            // Call the GetGameSpecs method to fetch system specs for LOL
            SystemSpec gameSpecs = dataAccess.GetGameSpecs(lolGameID);
            ...
            if (gameSpecs != null)
            {
                ...
                MessageBox.Show(specsMessage, "League of Legends System Specifications", MessageBoxButtons.OK);
            }
            else
            {
                MessageBox.Show("System specifications not found for League of Legends.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
