...
namespace CyberSpaceApp.UI_Forms
{
    public partial class RocketLeague : Form
    {
        ...
        private void RocketLeagueSpecs_Click(object sender, EventArgs e)
        {
            int rocketleagueGameID = 12;
            ...
            // Call the GetGameSpecs method to fetch system specs for Rocket League
            SystemSpec gameSpecs = dataAccess.GetGameSpecs(rocketleagueGameID);
            ...
            if (gameSpecs != null)
            {
                ...
                MessageBox.Show(specsMessage, "Rocket League System Specifications", MessageBoxButtons.OK);
            }
            else
            {
                MessageBox.Show("System specifications not found for Rocket League.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
